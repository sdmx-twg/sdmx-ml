...
if rtdVersion not in ['stable', 'latest', 'develop', 'i1-doc']:
  rtdVersion = 'stable'
...
s.toctree("Technical Specification", 3) \
  .subPrjToc("sdmx-im/Section1/SDMX_2-1_SECTION_1_Framework", "") \
  .subPrjToc("sdmx-im", "Sections/Section2/SDMX_2_1_SECTION_2_InformationModel") \
  .newLine()

s.toctree("Formats") \
  .sdmxLocalToc("sdmx-ml v1.0", "sdmxml/v10")  \
  .sdmxLocalToc("sdmx-ml v2.0", "sdmxml/v20")  \
  .sdmxLocalToc("sdmx-ml v2.1", "sdmxml/v21")  \
  .subPrjToc("sdmx-csv", "SDMX CSV (TBD)")  \
  .subPrjToc("sdmx-json", "SDMX JS") \
  .newLine()
